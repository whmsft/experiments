...
toy_data = ["""This article attempts to provide a general introduction to atheism.  Whilst I
...
# sample training
#print(word2vec_model.wv['word2vec'])
print(word2vec_model.wv.most_similar('atheist'))
...
for filename in os.listdir(directory):
    if filename.endswith(".txt"):
        ...
        with open(file_path, "r", encoding="utf-8") as file:
            ...
            # Now 'filtered_tokens' contains the tokenized text without stop words
